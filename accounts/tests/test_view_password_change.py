...
class PasswordChangeTests(TestCase):
    ...
    def test_form_inputs(self):
        ...
        # Find the one that contains 'old_password' input (i.e., the password change form)
        target_form = None
        for form in forms:
            if form.find('input', {'name': 'old_password'}):
                target_form = form
                break

        self.assertIsNotNone(target_form, "Password change form not found.")
